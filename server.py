...
def weather():
    ...
    zipcode = request.args.get('zipcode') # request.args = query string dict.
    print(zipcode)
    weather_info = WEATHER.get(zipcode, DEFAULT_WEATHER) # .get() = dict method with 2 params -> (key whose value you want, default if not found)
    print(weather_info)
